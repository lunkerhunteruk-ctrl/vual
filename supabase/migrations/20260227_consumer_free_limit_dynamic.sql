-- Update deduct_consumer_credit to accept a dynamic free ticket limit
-- instead of hardcoded 3. The limit comes from store_credits.daily_tryon_limit.
...
BEGIN
  ...
  -- Auto-reset free tickets if due (use dynamic limit)
