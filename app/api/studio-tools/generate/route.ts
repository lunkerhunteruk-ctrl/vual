...
- CUSTOMNOTE LENGTH — SCALE WITH SHOT SIZE:
  WIDE / ESTABLISHING (SA1, SB1, SB3, SB5, SB6, AA3, AB2, AB3, PC5, PD4, PE4): 5 sentences — (1) model's precise pose or action; (2) specific named objects/surfaces immediately around her; (3) what fills the BACKGROUND and FRAME EDGES visible behind her; (4) lighting and atmospheric detail unique to this micro-location; (5) the visual or emotional tension created by her presence here.
  FULL BODY / MEDIUM (SB2, SB4, PA1–PA6, PB1–PB6, PC1–PC4, PD1–PD7, PF1–PF7c, PG1–PG8, PE1–PE8): 4 sentences — (1) exact pose or action; (2) the specific named object/surface she's touching, sitting on, or near; (3) partial background or context visible in frame; (4) the tension or mood.
  DETAIL / FACE CLOSE-UP (DA1–DA6): 2 sentences — (1) exact head angle and crop; (2) the one visual element that creates tension within the tight frame.
  MEDIUM DETAIL (DB1–DB8, DC1–DC6, PF3, PF5, PF8): 3 sentences — (1) which body part or object is the focus and the angle; (2) specific surface or environmental context around it; (3) the emotional charge of the close framing.
