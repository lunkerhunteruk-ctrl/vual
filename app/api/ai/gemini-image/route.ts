...
- The overall feeling is fresh, optimistic, real — like a photo from a model's "day in my life" Instagram story.`;
    ...
    const offshotCCategories = [
      // Shot 1: HOTEL BREAKFAST
      {
        ...
        location: `A hotel restaurant or breakfast area in ${cityName || 'the shooting location'} serving ${breakfastType}. ${cityContextC} Morning light through large windows, other hotel guests visible in background. White tablecloths or clean modern tables.`,
      ...
      // Shot 2: HOTEL ROOM — GETTING READY
      {
        ...
        location: `A hotel bathroom/vanity area in ${cityName || 'the shooting location'}. ${cityContextC} Clean, modern hotel bathroom with large mirror, bright vanity lights, marble or tile countertop. Makeup products, brushes, hair tools scattered on the counter. Morning window light mixing with vanity lighting.`,
      ...
      // Shot 3: HOTEL ROOM — BED SCENE
      {
        ...
        location: `A hotel room in ${cityName || 'the shooting location'}. ${cityContextC} Unmade king-size bed with white sheets, scattered personal items creating an editorial still-life. Soft morning light through curtains. The room shows signs of someone living in it — open suitcase, hanging clothes, shoes by the door.`,
        film: leicaMorning, quality: qualityInterior,
      ...
      // Shot 4: HOTEL CHECKOUT / LOBBY
      {
        ...
        wardrobe: `${garmentDesc}${secondGarmentDesc}${thirdGarmentDesc}${fourthGarmentDesc}${fifthGarmentDesc} — now dressed for the day in the shoot wardrobe or a stylish travel outfit. Sunglasses pushed up on her head or hanging from the collar. A tote bag or small carry-on`,
        location: `The lobby or front desk of a hotel in ${cityName || 'the shooting location'}. ${cityContextC} Modern or boutique hotel interior, clean design, morning activity — other guests checking out, staff behind the desk. Bright natural light from the entrance.`,
      ...
      // Shot 5: TAXI / CAR RIDE TO LOCATION
      {
        ...
        wardrobe: `${garmentDesc}${secondGarmentDesc}${thirdGarmentDesc}${fourthGarmentDesc}${fifthGarmentDesc} — fully dressed for the shoot, sunglasses on or pushed up, bag on the seat beside her`,
      ...
      // Shot 6: CAFE — COFFEE & LUNCH
      {
        ...
        wardrobe: `${garmentDesc}${secondGarmentDesc}${thirdGarmentDesc}${fourthGarmentDesc}${fifthGarmentDesc} — dressed and styled for the day. Sunglasses on top of head or on the table. A light jacket or bag draped over the chair`,
