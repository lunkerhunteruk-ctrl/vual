...
- CUSTOMNOTE DEPTH — REQUIRED ELEMENTS BY SHOT TYPE (cover ALL listed elements; sentence count is your call):
  WIDE / ESTABLISHING (SA1, SB1, SB3, SB5, SB6, AA3, AB2, AB3, PC5, PD4, PE4): Cover ALL of — (1) model's precise pose or action; (2) specific named objects/surfaces immediately around her; (3) what fills the BACKGROUND and FRAME EDGES visible behind her; (4) lighting and atmospheric quality unique to this exact micro-location; (5) the visual or emotional tension of her presence here. Do not skip any element.
  FULL BODY / MEDIUM (SB2, SB4, PA1–PA6, PB1–PB6, PC1–PC4, PD1–PD7, PF1–PF7c, PG1–PG8, PE1–PE8): Cover ALL of — (1) model's exact pose or action; (2) the specific named object/surface she's touching, sitting on, or near; (3) partial background or context visible in frame; (4) the tension or mood created. Do not skip any element.
  DETAIL / FACE CLOSE-UP (DA1–DA6): Cover — (1) exact head angle and what is cropped into frame; (2) the one visual element that creates tension within the tight frame. Keep it tight — no background description needed.
  MEDIUM DETAIL (DB1–DB8, DC1–DC6, PF3, PF5, PF8): Cover ALL of — (1) which body part or object is the focus and from what angle; (2) specific surface or environmental context immediately around it; (3) the emotional charge of the close framing. Do not skip any element.
...
- DIRECTOR NAME BAN: NEVER write "Sachio's vision", "Sachio wants", or any reference to the director's name or internal production intent in the customNote. Image AI cannot interpret these — replace with concrete visual descriptions of the model, environment, and objects.
- CUSTOMNOTE DEPTH — REQUIRED ELEMENTS BY SHOT TYPE (cover ALL listed elements; sentence count is your call):
  WIDE / ESTABLISHING (SA1, SB1, SB3, SB5, SB6, AA3, AB2, AB3, PC5, PD4, PE4): Cover ALL of — (1) model's precise pose or action; (2) specific named objects/surfaces immediately around her; (3) what fills the BACKGROUND and FRAME EDGES visible behind her; (4) lighting and atmospheric quality unique to this exact micro-location; (5) the visual or emotional tension of her presence here. Do not skip any element.
  FULL BODY / MEDIUM (SB2, SB4, PA1–PA6, PB1–PB6, PC1–PC4, PD1–PD7, PF1–PF7c, PG1–PG8, PE1–PE8): Cover ALL of — (1) model's exact pose or action; (2) the specific named object/surface she's touching, sitting on, or near; (3) partial background or context visible in frame; (4) the tension or mood created. Do not skip any element.
  DETAIL / FACE CLOSE-UP (DA1–DA6): Cover — (1) exact head angle and what is cropped into frame; (2) the one visual element that creates tension within the tight frame. Keep it tight — no background description needed.
