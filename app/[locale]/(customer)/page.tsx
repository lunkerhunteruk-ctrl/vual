    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-24 md:py-36 text-center">
          ...
          <Link
            href={`/${locale}/signup`}
            className="btn-dark inline-flex items-center gap-3 px-12 py-5 bg-black text-lg font-bold rounded-full hover:bg-neutral-800 transition-all shadow-xl shadow-black/25 hover:shadow-2xl hover:scale-[1.02]"
          >
      ...
      <section className="border-t border-neutral-100">
        <div className="max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <Link
            href={`/${locale}/signup`}
            className="btn-dark inline-flex items-center gap-2 px-10 py-4 bg-neutral-900 text-base font-semibold rounded-full hover:bg-neutral-800 transition-colors shadow-lg shadow-neutral-900/20"
          >
